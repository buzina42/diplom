                    ...
                    <div className="row">
                        <div className="col-xl-9 col-lg-10 m-auto">
                            <div className="section-title">
                                ...
                                <p>CrossFit is a cutting-edge functional fitness system that can help everyday men.
                                    There is
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="about-quality">
                                ...
                                <ul>
                                    <li><i className="fa fa-check-circle-o"></i>Lorem ipsum dolor sitdoni amet,
                                        consectetur dont adipis elite vivamus interdum.
                                    </li>
                                    <li><i className="fa fa-check-circle-o"></i>Integer pulvinar ante nulla, ac
                                        fermentum ex congue id vestibulum ensectetur.
                                    </li>
                                    <li><i className="fa fa-check-circle-o"></i>Proin blandit nibh in quam semper
                                        iaculis lorem ipsum dolor salama ender.
                                    </li>
                                    <li><i className="fa fa-check-circle-o"></i>Quis ipsum suspendisse ultrices
                                        gravida.
